    ...
    <div class="add-balance-container">
      ...
      <form @submit.prevent="addBalance">
        ...
        <div class="form-group">
          ...
          <input type="text" id="cardExpiry" v-model="cardExpiry" required>
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    async addBalance() {
      ...
      try {
        const response = await fetch('http://54.197.171.146:8080/index.php?path=add-balance', {
          method: 'POST',
          headers: {
        ...
        alert('Error añadiendo saldo. Por favor, inténtalo de nuevo.');
      }
    }
  }
};
