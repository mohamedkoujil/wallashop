      ...
      <div class="add-balance-container">
          ...
          <div class="flip-card-inner">
            <div class="flip-card-front">
              ...
              <svg version="1.1" class="chip" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 50 50" xml:space="preserve">
                <image id="image0" width="50" height="50" x="0" y="0" href="https://i.ibb.co/SQwmspR/chip.png"></image>
              </svg>
              ...
              <p class="date_8264">{{ cardExpiry }}</p>
        ...
        <form @submit.prevent="addBalance">
          <div class="form-group">
            ...
            <input type="text" id="cardNumber" v-model="cardNumber" placeholder="1234 5678 9123 4567" required>
          </div>
          <div class="form-group">
            <label for="cardExpiry">Fecha de Expiración:</label>
            <input type="text" id="cardExpiry" v-model="cardExpiry" placeholder="MM/AA" required>
          </div>
          <div class="form-group">
            <label for="cardName">Nombre en la Tarjeta:</label>
            <input type="text" id="cardName" v-model="cardName" placeholder="Nombre Apellido" required>
          </div>
          <div class="form-group">
            <label for="amount">Cantidad:</label>
            <input type="number" id="amount" v-model="amount" placeholder="€" required>
          </div>
  ...
  export default {
    ...
    methods: {
      async addBalance() {
        ...
        if (!user) {
          alert('Debes iniciar sesión para añadir saldo.');
          return;
        }
  
        const response = await fetch('http://107.21.164.204:8080/index.php?path=add-balance', {
          method: 'POST',
          headers: {
